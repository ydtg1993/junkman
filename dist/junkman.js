var junkman = (function (exports) {
  ...
  <path fill-rule="evenodd" d="M6 3.5A1.5 1.5 0 0 1 7.5 2h1A1.5 1.5 0 0 1 10 3.5v1A1.5 1.5 0 0 1 8.5 6v1H14a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-1 0V8h-5v.5a.5.5 0 0 1-1 0V8h-5v.5a.5.5 0 0 1-1 0v-1A.5.5 0 0 1 2 7h5.5V6A1.5 1.5 0 0 1 6 4.5v-1zm-6 8A1.5 1.5 0 0 1 1.5 10h1A1.5 1.5 0 0 1 4 11.5v1A1.5 1.5 0 0 1 2.5 14h-1A1.5 1.5 0 0 1 0 12.5v-1zm6 0A1.5 1.5 0 0 1 7.5 10h1a1.5 1.5 0 0 1 1.5 1.5v1A1.5 1.5 0 0 1 8.5 14h-1A1.5 1.5 0 0 1 6 12.5v-1zm6 0a1.5 1.5 0 0 1 1.5-1.5h1a1.5 1.5 0 0 1 1.5 1.5v1a1.5 1.5 0 0 1-1.5 1.5h-1a1.5 1.5 0 0 1-1.5-1.5v-1z"/>
     ...
     */
    function ImgLoader(doms, time = 200, options = {}) {
        const { zoom = false, width = 300, height = 0, previewClass = '', mode = 'sync', } = options;
        const cleanupFns = [];
        ...
        doms.forEach((dom, idx) => {
            ...
            const setupZoom = () => {
                ...
                cleanupFns.push(() => {
                    if (mouseoverHandler)
                        img.removeEventListener('mouseover', mouseoverHandler);
                    if (mouseoutHandler)
            ...
            cleanupFns.push(() => {
                ...
                if (mouseoverHandler && img)
                    img.removeEventListener('mouseover', mouseoverHandler);
                if (mouseoutHandler && img)
                    img.removeEventListener('mouseout', mouseoutHandler);
                if (previewImg) {
                    previewImgs.delete(previewImg);
                    previewImg.remove();
    ...
    class Select {
        constructor(container, select, options) {
            this.select = {};
            this.selectedData = [];
            this.selectData = [];
            this.insertData = [];
            ...
            if (typeof container === 'string') {
                ...
                if (!el)
                    throw new Error(`Selector container not found: ${container}`);
                this.container = el;
            }
...
<input name="${name}[delete]" value="[]" type="hidden" />`);
    ...
    class Switcher extends Select {
        ...
        make() {
            ...
            // 保存按钮容器引用
            this.buttonContainer = createDOMFromTree(domTree, this.container);
    ...
    class Table {
        constructor(selector, columns, options = {}) {
            ...
            this.options = {
                ...
                border: (_c = options.border) !== null && _c !== void 0 ? _c : true, // 未使用，统一强制启用
                zebra: (_d = options.zebra) !== null && _d !== void 0 ? _d : true, // 未使用，统一强制启用
            ...
            switch (col.type) {
                ...
                case 'selector': {
                    if (isEditable) {
                        ...
                        const menu = new Selector(menuContainer, selectData, {
                            ...
                            show: false,
                            direction: exports.SELECTOR_DIRECTION.Down,
                        });
                        menu.make();
                ...
                case 'image': {
                    ...
                    if (col.delay) {
                        ...
                        if (col.zoomOptions)
                            this.imgLoaderSettings = col.zoomOptions;
                    }
                    else {
                        img.src = value;
                    }
    ...
    class FormBuilder {
         ...
         */
        static registerWidget(name, factory) {
